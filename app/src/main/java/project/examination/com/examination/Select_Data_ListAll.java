...
public class Select_Data_ListAll extends Activity {
	...
	ListView listview;
	 public void onCreate(Bundle savedInstanceState){
	  ...
	  textView1sss.setText("เลือกรายวิชา");
	  ...
	  //edittext = (EditText) findViewById(R.id.EditText01);
		...
		public void onBackPressed() {
			 ...
			 Select_Data_ListAll.this.finish();
					...
					public void onClick(View v) {
						...
						for(int j=0;j<File_Confix_Data.getGetDepartment.size();j++){
							...
							if( File_Confix_Data.getGetDepartment.get(j).getDepartment_id()==Integer.parseInt(catID)){
								...
								File_Confix_Data.DepartmentId=File_Confix_Data.getGetDepartment.get(j).getDepartment_id();
							}
						}

						//
						Intent intent = new Intent(Select_Data_ListAll.this , Select_Data_list.class);
