...
public class DatabasepoinRegister extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databaseregisterq";

    // Table Name
    private static final String TABLE_NAME = "databaseregisterqtable";

	public DatabasepoinRegister(Context context) {
